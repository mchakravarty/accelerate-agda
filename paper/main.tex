...
\begin{verbatim}
fold : forall {E}{sh}{n} -> (f : Exp E -> Exp E -> Exp E) -> (e : Exp E)
     -> Array (sh :< n >) E -> IsMonoid f e -> Array sh E
\end{verbatim}
where
\begin{verbatim}
IsMonoid : forall {E} -> (f : Exp E -> Exp E -> Exp E) -> (e : Exp E) -> Set
...
its presence.\footnote{The \texttt{Maybe} type is not an option
...
\begin{verbatim}
use : forall {sh : Shape}{E : Element} -> PreArray sh E -> Array sh E
